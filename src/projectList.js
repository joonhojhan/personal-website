export default [
	...
	{
		name: 'Food Picker',
		imageUrl: 'FoodPicker.png',
		description:
			"We've all gone through the pain of trying to decide where to eat when you're alone or with a group of friends. Food Picker is a React Native mobile app that helps you decide where to eat. Food Picker uses the Yelp API to grab data from Yelp and Google Maps to conveniently display the location of the restaurant chosen. With the help of Food Picker, you'll never have trouble deciding where to eat ever again!",
		technologies: 'React Native, Expo, Yelp API, Google Maps',
		github: 'https://github.com/joonhojhan/stackathon-food-picker',
	},
	{
		name: 'Gracejammer',
		imageUrl: 'Gracejammer.png',
		description:
